 ...
 * {@link com.intellect.springbootcud.repository.User} objects.
 * @author Arun
 */
interface UserService {
     ...
     * @throws com.UserNotFoundException.bootrest.user.UserNotFoundException if no user entry is found.
     */
